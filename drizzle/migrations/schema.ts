import { pgTable, text, timestamp, bigint, index, bigserial, jsonb, doublePrecision, primaryKey, integer } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"



export const retrainPointer = pgTable("retrain_pointer", {
